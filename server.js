...
var client_id = process.env.clientId; // my client id
var client_secret = process.env.clientSecret; // my secret
var redirect_uri = process.env.redirectURL; // my Your redirect uri
